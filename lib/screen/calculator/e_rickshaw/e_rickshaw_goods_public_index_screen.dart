...
class ERickshawGoodsPublicIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ERickshawGoodsPublicIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ERickshawGoodsPublicIndexScreen> createState() => _ERickshawGoodsPublicIndexScreenState();
}

class _ERickshawGoodsPublicIndexScreenState extends State<ERickshawGoodsPublicIndexScreen> {
  double idv = 0;

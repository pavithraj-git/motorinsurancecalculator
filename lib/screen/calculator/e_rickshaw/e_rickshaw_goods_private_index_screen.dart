...
class ERickshawGoodsPrivateIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ERickshawGoodsPrivateIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ERickshawGoodsPrivateIndexScreen> createState() => _ERickshawGoodsPrivateIndexScreenState();
}

class _ERickshawGoodsPrivateIndexScreenState extends State<ERickshawGoodsPrivateIndexScreen> {
  double idv = 0;

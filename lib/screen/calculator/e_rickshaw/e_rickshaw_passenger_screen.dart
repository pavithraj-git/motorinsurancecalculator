...
import 'e_rickshaw_passenger_index_screen.dart';

class ERickshawPassengerScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ERickshawPassengerScreen({super.key, this.title, this.bikeCC});

  @override
  State<ERickshawPassengerScreen> createState() => _ERickshawPassengerScreenState();
}

class _ERickshawPassengerScreenState extends State<ERickshawPassengerScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ERickshawPessengerIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

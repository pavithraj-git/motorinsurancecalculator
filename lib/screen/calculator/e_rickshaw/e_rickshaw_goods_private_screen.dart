...
import 'e_rickshaw_goods_private_index_screen.dart';

class ERickshawGoodsPrivateScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ERickshawGoodsPrivateScreen({super.key, this.title, this.bikeCC});

  @override
  State<ERickshawGoodsPrivateScreen> createState() => _ERickshawGoodsPrivateScreenState();
}

class _ERickshawGoodsPrivateScreenState extends State<ERickshawGoodsPrivateScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ERickshawGoodsPrivateIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
import 'package:motorinsurancecalculator/screen/calculator/car/private_car_1od_1tp_index_screen.dart';
import 'package:motorinsurancecalculator/screen/calculator/car/private_car_1od_3tp_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/private_car_1od_1tp_controller.dart';

class PrivateCar1OD1TPScreen extends StatefulWidget {
  String? title;
  PrivateCar1OD1TPScreen({super.key, this.title});

  @override
  State<PrivateCar1OD1TPScreen> createState() => _PrivateCar1OD1TPScreenState();
}

class _PrivateCar1OD1TPScreenState extends State<PrivateCar1OD1TPScreen> {
  final PrivateCar1OD1TPController two = Get.put(PrivateCar1OD1TPController());

  @override
  void dispose() {
    Get.delete<PrivateCar1OD1TPController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateCar1OD1TPIndexScreen(data: value, title: widget.title)));

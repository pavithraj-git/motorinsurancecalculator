...
class PrivateCarNationalScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  PrivateCarNationalScreen({super.key, this.title, this.bikeCC});

  @override
  State<PrivateCarNationalScreen> createState() => _PrivateCarNationalScreenState();
}

class _PrivateCarNationalScreenState extends State<PrivateCarNationalScreen> {
  final PrivateCarNationalController two = Get.put(PrivateCarNationalController());


  @override
  void dispose() {
    Get.delete<PrivateCarNationalController>(); // clear controller
    super.dispose();
  }
              ...
              child: Column(
                children: [
                  ...
                  CDropDown(
                    value: two.state,
                    title: "State",
                    items: two.stateList.map((String e) {
                      return DropdownMenuItem<String>(
                        value: e,
                        child: Text(e),
                      );
                  ...
                  SizedBox(height: 5,),
                  CDropDown(
                      value: two.lockKeyPro,
                      title: "Lock and Key Protect",
                      items: two.lockKeyProList.map((String e) {
                        return DropdownMenuItem<String>(
                          value: e,
                          child: Text(e),
                        );
                      ...
                      onchage: (value){
                        setState(() {
                          two.lockKeyPro = value;
                        });
                      }),
                  SizedBox(height: 5,),
                  CTextField(
                    title: "Lock and Key Amount (min-5000)",
                    controller: two.lockKeyAmountController.value,
                    keyboard: TextInputType.number,
                  ),
                  SizedBox(height: 5,),
                  CDropDown(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          var value = TwoWheelerPremiumModel(
                            ...
                            lockKeyPro: two.lockKeyPro,
                            lockKeyAmount: two.lockKeyAmountController.value.text,
                            ncb: two.ncb,
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateCarNationalIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

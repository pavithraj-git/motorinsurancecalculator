...
import 'package:motorinsurancecalculator/controller/electric_car_1od_1tp_controller.dart';
import 'package:motorinsurancecalculator/model/two_wheeler_premium_model.dart';
import 'package:motorinsurancecalculator/screen/calculator/car/electric_car_1od_1tp_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/private_car_complete_controller.dart';

class ElectricCar1OD1TPScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricCar1OD1TPScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricCar1OD1TPScreen> createState() => _ElectricCar1OD1TPScreenState();
}

class _ElectricCar1OD1TPScreenState extends State<ElectricCar1OD1TPScreen> {
  final ElectricCar1OD1TPController two = Get.put(ElectricCar1OD1TPController());


  @override
  void dispose() {
    Get.delete<ElectricCar1OD1TPController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricCar1OD1TPIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
class ElectricCar1OD3TPIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ElectricCar1OD3TPIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ElectricCar1OD3TPIndexScreen> createState() => _ElectricCar1OD3TPIndexScreenState();
}

class _ElectricCar1OD3TPIndexScreenState extends State<ElectricCar1OD3TPIndexScreen> {
  double idv = 0;

...
import 'package:motorinsurancecalculator/controller/electric_car_complete_controller.dart';
import 'package:motorinsurancecalculator/model/two_wheeler_premium_model.dart';
import 'package:motorinsurancecalculator/screen/calculator/car/electric_car_complete_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/private_car_complete_controller.dart';

class ElectricCarCompleteScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricCarCompleteScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricCarCompleteScreen> createState() => _ElectricCarCompleteScreenState();
}

class _ElectricCarCompleteScreenState extends State<ElectricCarCompleteScreen> {
  final ElectricCarCompleteController two = Get.put(ElectricCarCompleteController());


  @override
  void dispose() {
    Get.delete<ElectricCarCompleteController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricCarCompleteIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

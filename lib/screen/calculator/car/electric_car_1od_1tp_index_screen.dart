...
class ElectricCar1OD1TPIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ElectricCar1OD1TPIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ElectricCar1OD1TPIndexScreen> createState() => _ElectricCar1OD1TPIndexScreenState();
}

class _ElectricCar1OD1TPIndexScreenState extends State<ElectricCar1OD1TPIndexScreen> {
  double idv = 0;

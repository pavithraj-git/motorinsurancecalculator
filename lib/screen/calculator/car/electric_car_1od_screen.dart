...
import 'package:motorinsurancecalculator/controller/electric_car_1od_controller.dart';
import 'package:motorinsurancecalculator/model/two_wheeler_premium_model.dart';
import 'package:motorinsurancecalculator/screen/calculator/car/electric_car_1od_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/private_car_complete_controller.dart';

class ElectricCar1ODScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricCar1ODScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricCar1ODScreen> createState() => _ElectricCar1ODScreenState();
}

class _ElectricCar1ODScreenState extends State<ElectricCar1ODScreen> {
  final ElectricCar1ODController two = Get.put(ElectricCar1ODController());


  @override
  void dispose() {
    Get.delete<ElectricCar1ODController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricCar1ODIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

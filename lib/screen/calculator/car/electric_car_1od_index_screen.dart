...
class ElectricCar1ODIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ElectricCar1ODIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ElectricCar1ODIndexScreen> createState() => _ElectricCar1ODIndexScreenState();
}

class _ElectricCar1ODIndexScreenState extends State<ElectricCar1ODIndexScreen> {
  double idv = 0;

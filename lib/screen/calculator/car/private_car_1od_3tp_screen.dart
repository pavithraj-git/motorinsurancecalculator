...
import '../../../controller/private_car_1od_3tp_controller.dart';

class PrivateCar1OD3TPScreen extends StatefulWidget {
  String? title;
  PrivateCar1OD3TPScreen({super.key, this.title});

  @override
  State<PrivateCar1OD3TPScreen> createState() => _PrivateCar1OD3TPScreenState();
}

class _PrivateCar1OD3TPScreenState extends State<PrivateCar1OD3TPScreen> {
  final PrivateCar1OD3TPController two = Get.put(PrivateCar1OD3TPController());

  @override
  void dispose() {
    Get.delete<PrivateCar1OD3TPController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateCar1OD3TPIndexScreen(data: value, title: widget.title)));

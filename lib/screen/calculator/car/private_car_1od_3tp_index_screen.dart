...
class PrivateCar1OD3TPIndexScreen extends StatefulWidget {
  String? title;
  TwoWheelerPremiumModel? data;
  PrivateCar1OD3TPIndexScreen({super.key, this.title, this.data});

  @override
  State<PrivateCar1OD3TPIndexScreen> createState() => _PrivateCar1OD3TPIndexScreenState();
}

class _PrivateCar1OD3TPIndexScreenState extends State<PrivateCar1OD3TPIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      liability = two.carLiability5TP(widget.data?.cubieCapacity);

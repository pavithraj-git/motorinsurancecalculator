...
class PrivateCarComprehensiveScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  PrivateCarComprehensiveScreen({super.key, this.title, this.bikeCC});

  @override
  State<PrivateCarComprehensiveScreen> createState() => _PrivateCarComprehensiveScreenState();
}

class _PrivateCarComprehensiveScreenState extends State<PrivateCarComprehensiveScreen> {
  final PrivateCarComprehensiveController two = Get.put(PrivateCarComprehensiveController());


  @override
  void dispose() {
    Get.delete<PrivateCarComprehensiveController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateCarComprehensiveIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
import '../../../controller/private_car_complete_1od_controller.dart';

class PrivateCarComplete1ODScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  PrivateCarComplete1ODScreen({super.key, this.title, this.bikeCC});

  @override
  State<PrivateCarComplete1ODScreen> createState() => _PrivateCarComplete1ODScreenState();
}

class _PrivateCarComplete1ODScreenState extends State<PrivateCarComplete1ODScreen> {
  final PrivateCarComplete1ODController two = Get.put(PrivateCarComplete1ODController());


  @override
  void dispose() {
    Get.delete<PrivateCarComplete1ODController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateCarComplete1ODIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
import 'package:motorinsurancecalculator/controller/taxi_controller.dart';
import 'package:motorinsurancecalculator/model/two_wheeler_premium_model.dart';
import 'package:motorinsurancecalculator/screen/calculator/taxi/taxi_index_screen.dart';
...
class TaxiScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TaxiScreen({super.key, this.title, this.bikeCC});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => TaxiIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
import 'package:motorinsurancecalculator/screen/calculator/taxi/electric_taxi_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/taxi_controller.dart';

class ElectricTaxiScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricTaxiScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricTaxiScreen> createState() => _ElectricTaxiScreenState();
}

class _ElectricTaxiScreenState extends State<ElectricTaxiScreen> {
  final TaxiController two = Get.put(TaxiController());


  @override
  void dispose() {
    Get.delete<TaxiController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricTaxiIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

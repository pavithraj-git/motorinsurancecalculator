...
class ElectricTaxiIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ElectricTaxiIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ElectricTaxiIndexScreen> createState() => _ElectricTaxiIndexScreenState();
}

class _ElectricTaxiIndexScreenState extends State<ElectricTaxiIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      passengerCov = 949 * double.parse(widget.data!.noPassenger.toString());

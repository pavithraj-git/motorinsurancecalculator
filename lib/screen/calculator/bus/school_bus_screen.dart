...
import 'package:motorinsurancecalculator/screen/calculator/bus/school_bus_index_screen.dart';
...
class SchoolBusScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  SchoolBusScreen({super.key, this.title, this.bikeCC});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => SchoolBusIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

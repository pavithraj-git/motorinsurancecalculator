...
class SchoolBusIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  SchoolBusIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<SchoolBusIndexScreen> createState() => _SchoolBusIndexScreenState();
}

class _SchoolBusIndexScreenState extends State<SchoolBusIndexScreen> {
  double idv = 0;

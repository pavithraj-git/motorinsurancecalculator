...
class ElectricSchoolBusIndexScreen extends StatefulWidget {
  ...
  ElectricSchoolBusIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ElectricSchoolBusIndexScreen> createState() => _ElectricSchoolBusIndexScreenState();
}

class _ElectricSchoolBusIndexScreenState extends State<ElectricSchoolBusIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      passengerCov = 713 * double.parse(widget.data!.noPassenger.toString());

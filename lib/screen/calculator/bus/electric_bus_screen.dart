...
import 'package:motorinsurancecalculator/screen/calculator/bus/electric_bus_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/bus_controller.dart';
import 'bus_index_screen.dart';

class ElectricBusScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricBusScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricBusScreen> createState() => _ElectricBusScreenState();
}

class _ElectricBusScreenState extends State<ElectricBusScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricBusIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

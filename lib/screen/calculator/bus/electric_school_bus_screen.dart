...
import 'electric_school_bus_index_screen.dart';

class ElectricSchoolBusScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ElectricSchoolBusScreen({super.key, this.title, this.bikeCC});

  @override
  State<ElectricSchoolBusScreen> createState() => _ElectricSchoolBusScreenState();
}

class _ElectricSchoolBusScreenState extends State<ElectricSchoolBusScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ElectricSchoolBusIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

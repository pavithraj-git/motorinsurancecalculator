...
class BusIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  BusIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<BusIndexScreen> createState() => _BusIndexScreenState();
}

class _BusIndexScreenState extends State<BusIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      passengerCov = 877 * double.parse(widget.data!.noPassenger.toString());

...
import 'package:motorinsurancecalculator/screen/calculator/bike/two_wheeler_passenger_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/two_wheeler_passenger_controller.dart';

class TwoWheelerPassengerScreen extends StatefulWidget {
  String? title;
  TwoWheelerPassengerScreen({super.key, this.title});

  @override
  State<TwoWheelerPassengerScreen> createState() => _TwoWheelerPassengerScreenState();
}

class _TwoWheelerPassengerScreenState extends State<TwoWheelerPassengerScreen> {
  final TwoWheelerPassengerController two = Get.put(TwoWheelerPassengerController());

  @override
  void dispose() {
    Get.delete<TwoWheelerPassengerController>(); // clear controller
    super.dispose();
  }
              ...
              child: Column(
                children: [
                  ...
                  CTextField(
                    ...
                    controller: two.noPassengerController.value,
                    keyboard: TextInputType.number,
                  ),
                  SizedBox(height: 5,),
                  CTextField(
                  ...
                  CDropDown(
                      value: two.cngKits,
                      title: "CNG/LPG Kits",
                      items: two.cngKitsList.map((String e) {
                        return DropdownMenuItem<String>(
                          value: e,
                          child: Text(e),
                        );
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          var value = TwoWheelerPremiumModel(
                            ...
                            noPassenger: two.noPassengerController.value.text,
                            imt23: two.imt23,
                            cngKits: two.cngKits,
                            cngEx: two.cngExtController.value.text
                          );
                          Navigator.push(context, MaterialPageRoute(builder: (context) => TwoWheelerPassengerIndexScreen(data: value, title: widget.title)));

...
import 'misc_index_screen.dart';

class MISCScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  MISCScreen({super.key, this.title, this.bikeCC});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => MISCIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

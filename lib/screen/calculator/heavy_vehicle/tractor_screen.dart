...
import 'package:motorinsurancecalculator/screen/calculator/heavy_vehicle/tractor_index_screen.dart';
...
class TractorScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TractorScreen({super.key, this.title, this.bikeCC});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => TractorIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

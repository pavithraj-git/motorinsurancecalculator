...
import 'package:motorinsurancecalculator/screen/calculator/heavy_vehicle/trailer_index_screen.dart';
...
class TrailerScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TrailerScreen({super.key, this.title, this.bikeCC});
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => TrailerIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

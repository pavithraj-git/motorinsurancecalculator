...
class TractorIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  TractorIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<TractorIndexScreen> createState() => _TractorIndexScreenState();
}

class _TractorIndexScreenState extends State<TractorIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      GST = (totalA + cngKit + double.parse(widget.data!.paOwnerDriver.toString())

...
import 'hearses_index_screen.dart';

class HearsesScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  HearsesScreen({super.key, this.title, this.bikeCC});

  @override
  State<HearsesScreen> createState() => _HearsesScreenState();
}

class _HearsesScreenState extends State<HearsesScreen> {
              ...
              child: Column(
                children: [
                  ...
                  CDropDown(
                      ...
                      items: two.noClaimBonusTList.map((String e) {
                        return DropdownMenuItem<String>(
                          value: e,
                          child: Text(e),
                        );
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => HearsesIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

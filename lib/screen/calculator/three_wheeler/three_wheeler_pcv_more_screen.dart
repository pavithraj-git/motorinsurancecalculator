...
import 'package:motorinsurancecalculator/screen/calculator/three_wheeler/three_wheeler_pcv_more_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/three_wheeler_controller.dart';

class ThreeWheelerPCVMoreScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ThreeWheelerPCVMoreScreen({super.key, this.title, this.bikeCC});

  @override
  State<ThreeWheelerPCVMoreScreen> createState() => _ThreeWheelerPCVMoreScreenState();
}

class _ThreeWheelerPCVMoreScreenState extends State<ThreeWheelerPCVMoreScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ThreeWheelerPCVMoreIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

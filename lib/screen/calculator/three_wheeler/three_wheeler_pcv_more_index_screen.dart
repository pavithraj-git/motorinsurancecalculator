...
class ThreeWheelerPCVMoreIndexScreen extends StatefulWidget {
  ...
  ThreeWheelerPCVMoreIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ThreeWheelerPCVMoreIndexScreen> createState() => _ThreeWheelerPCVMoreIndexScreenState();
}

class _ThreeWheelerPCVMoreIndexScreenState extends State<ThreeWheelerPCVMoreIndexScreen> {
  double idv = 0;

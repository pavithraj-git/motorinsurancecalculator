...
import 'package:motorinsurancecalculator/screen/calculator/three_wheeler/three_wheeler_pcv_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/three_wheeler_controller.dart';

class ThreeWheelerPCVScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ThreeWheelerPCVScreen({super.key, this.title, this.bikeCC});

  @override
  State<ThreeWheelerPCVScreen> createState() => _ThreeWheelerPCVScreenState();
}

class _ThreeWheelerPCVScreenState extends State<ThreeWheelerPCVScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ThreeWheelerPCVIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

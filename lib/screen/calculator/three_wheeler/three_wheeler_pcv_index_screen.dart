...
class ThreeWheelerPCVIndexScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  TwoWheelerPremiumModel? data;
  ThreeWheelerPCVIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ThreeWheelerPCVIndexScreen> createState() => _ThreeWheelerPCVIndexScreenState();
}

class _ThreeWheelerPCVIndexScreenState extends State<ThreeWheelerPCVIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      totalA = netOwnDamage;
      passengerCov = 1134 * double.parse(widget.data!.noPassenger.toString());

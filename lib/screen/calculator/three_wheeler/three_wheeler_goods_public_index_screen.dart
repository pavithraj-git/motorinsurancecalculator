...
class ThreeWheelerGoodsPublicIndexScreen extends StatefulWidget {
  ...
  ThreeWheelerGoodsPublicIndexScreen({super.key, this.title, this.bikeCC, this.data});

  @override
  State<ThreeWheelerGoodsPublicIndexScreen> createState() => _ThreeWheelerGoodsPublicIndexScreenState();
}

class _ThreeWheelerGoodsPublicIndexScreenState extends State<ThreeWheelerGoodsPublicIndexScreen> {
  double idv = 0;
  ...
  initFun(){
    setState(() {
      ...
      if(widget.title == "Three Wheeler Goods Carrying Vehicles - Private"){
        if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.165;
        } else if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "B") {
          vehicleBasicRate = 1.159;
        } else if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "C") {
          vehicleBasicRate = 1.148;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.194;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "B") {
          vehicleBasicRate = 1.188;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "C") {
          vehicleBasicRate = 1.177;
        } else if (widget.data?.ageVehicle == "Above 7 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.223;
        } else if (widget.data?.ageVehicle == "Above 7 Year" &&
            widget.data?.zone == "B") {
          vehicleBasicRate = 1.217;
        } else {
          vehicleBasicRate = 1.205;
        }
      } else {
        if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.664;
        } else if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "B") {
          vehicleBasicRate = 1.656;
        } else if (widget.data?.ageVehicle == "Upto 5 Year" &&
            widget.data?.zone == "C") {
          vehicleBasicRate = 1.64;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.706;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "B") {
          vehicleBasicRate = 1.697;
        } else if (widget.data?.ageVehicle == "6 to 7 Year" &&
            widget.data?.zone == "C") {
          vehicleBasicRate = 1.681;
        } else if (widget.data?.ageVehicle == "Above 7 Year" &&
            widget.data?.zone == "A") {
          vehicleBasicRate = 1.747;
        } else if (widget.data?.ageVehicle == "Above 7 Year" &&
            widget.data?.zone == "B") {
      ...
      odBeforeNCB = (basicVehicle + cngExt + imt23 - disODPri);
      ...
      GST5 = (double.parse(liability.toString()) * 5 / 100) - (tppd * 5 / 100);
      GST = (totalA + cngKit + double.parse(widget.data!.paOwnerDriver.toString()) + double.parse(widget.data!.llPaidDriver.toString())) * 18 / 100;
      cess = totalAB * double.parse(widget.data!.otherCess.toString()) / 100;
      finalTotal = totalAB + GST + GST5 + cess;
    });
  }
  @override

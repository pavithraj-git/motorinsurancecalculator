...
import 'package:motorinsurancecalculator/screen/calculator/three_wheeler/three_wheeler_goods_public_index_screen.dart';

import '../../../common/color_constant.dart';
import '../../../controller/three_wheeler_controller.dart';

class ThreeWheelerGoodsPublicScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  ThreeWheelerGoodsPublicScreen({super.key, this.title, this.bikeCC});

  @override
  State<ThreeWheelerGoodsPublicScreen> createState() => _ThreeWheelerGoodsPublicScreenState();
}

class _ThreeWheelerGoodsPublicScreenState extends State<ThreeWheelerGoodsPublicScreen> {
  final ThreeWheelerController two = Get.put(ThreeWheelerController());


  @override
  void dispose() {
    Get.delete<ThreeWheelerController>(); // clear controller
    super.dispose();
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ThreeWheelerGoodsPublicIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

...
import 'package:motorinsurancecalculator/controller/carrying_public_controller.dart';
import 'package:motorinsurancecalculator/model/two_wheeler_premium_model.dart';
import 'package:motorinsurancecalculator/screen/calculator/goods_carring/carrying_public_index_screen.dart';

import '../../../common/color_constant.dart';

class CarryingPublicScreen extends StatefulWidget {
  String? title;
  String? bikeCC;
  CarryingPublicScreen({super.key, this.title, this.bikeCC});

  @override
  State<CarryingPublicScreen> createState() => _CarryingPublicScreenState();
}

class _CarryingPublicScreenState extends State<CarryingPublicScreen> {
  final CarryingPublicController two = Get.put(CarryingPublicController());


  @override
  void dispose() {
    Get.delete<CarryingPublicController>(); // clear controller
    super.dispose();
  }
              ...
              child: Column(
                children: [
                  ...
                  CTextField(
                    ...
                    controller: two.grassWeightController.value,
                    keyboard: TextInputType.number,
                  ),
                  SizedBox(height: 5,),
                  CTextField(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){
                          ...
                          var value = TwoWheelerPremiumModel(
                              ...
                              zone: two.zone,
                              grassWeight: two.grassWeightController.value.text,
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => CarryingPublicIndexScreen(data: value, title: widget.title, bikeCC: widget.bikeCC,)));

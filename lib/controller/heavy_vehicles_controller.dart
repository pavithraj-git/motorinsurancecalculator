...
class HeavyVehiclesController extends GetxController {
  ...
  final llPassengerController = TextEditingController(text: "0").obs;
  final noTrailersController = TextEditingController(text: "0").obs;
  ...
  List<String> noClaimBonusList = ["0", "20", "25", "35", "45", "50", "55", "65"];
  List<String> noClaimBonusTList = ["0", "20", "25", "35", "45", "50"];
  List<String> llPayedList = ["0", "50"];
  List<String> imt23List = ["Yes", "No"];
  List<String> llEmpPayedList = ["0", "50", "100", "150", "200", "250", "300", "350"];
  List<String> llEmpPayedListh = ["0", "50", "100", "150"];
  List<String> cngList = ["Yes", "No"];

  //
  List<String> vehicleTypeList = ["Other Vehicle", "Agriculture Tractors upto 6 HP"];
  List<String> overCranesList = ["Yes", "No"];
  ...
  //
  String? vehicleType = "Other Vehicle";
  String? overCranes = "No";
  String? geoGrap = "0";
  ...
  void emptyValueAssign(){
    ...
    if(llPassengerController.value.text.isEmpty){
      llPassengerController.value.text = "0";
    }
    if(noTrailersController.value.text.isEmpty){
      noTrailersController.value.text = "0";
    }
  }

...
class TwoWheelerPassengerController extends GetxController {
  ...
  final noPassengerController = TextEditingController(text: "0").obs;
  ...
  List<String> cngKitsList = ["Yes", "No"];
  ...
  void emptyValueAssign() {
    ...
    if (noPassengerController.value.text.isEmpty) {
      noPassengerController.value.text = "0";
    }
